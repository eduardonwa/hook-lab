...
TEXT,
    ...
    [
        ...
        'access_level' => 'free',
        'description' => 'Un hook que dice la verdad incómoda que la mayoría de las personas evita mencionar.',
    ],
    ...
    [
        ...
        'name' => 'Error Común',
        'access_level' => 'free',
        'description' => 'Un hook que señala un error que tu audiencia sigue repitiendo sin darse cuenta.',
    ],
    ...
    [
        ...
        'access_level' => 'free',
        'description' => 'Un hook que advierte al lector lo que necesita entender antes de tomar acción.',
    ],
