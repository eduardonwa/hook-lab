@php
    $cardSlot = 'h-[450px] w-full max-w-[300px] mx-auto';
    $cardShell = 'h-full w-full overflow-hidden rounded-2xl border border-gray-200 shadow-sm dark:border-white/10';
@endphp
                    ...
                    <div class="{{ $cardSlot }}">
                        @if ($isInDeck)
                            ...
                            <button
                                ...
                                class="{{ $cardShell }} group relative flex items-center justify-center bg-stone-200 transition hover:-translate-y-0.5 hover:shadow-lg"
                            >
                                <img
                        ...
                        @else
                            ...
                            <article
                                ...
                                wire:transition.opacity.scale.duration.250ms
                                class="{{ $cardShell }} flex flex-col gap-3 bg-white p-5 dark:bg-gray-900"
                            >
                                {{-- INNER TOP BAR --}}
